...
wordcloud (row.names (unknown[1:100]), as.numeric (unknown[1:100]), colors=rainbow (100))
```
...
and riplets of consequtive words
and linking them with the most frequent following word.
That will be the basic frquency table of the word predictor model,
...
print (ngram (paste (unlist (line), collapse=" ")), full=TRUE)
close (f)
```
